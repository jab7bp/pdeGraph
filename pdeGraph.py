...
#Determine number of photons at test/reference per each reference current
...
###Set the left margin (for appearances) for all graphs
for i in range(1,6):
...
###Set all of the error bars for the graphs
